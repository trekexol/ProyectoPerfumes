...
<section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
            <div class="col-9">
             @include('Presentacion_Perfume.newBtn')
            </div>
            <div class="col-3">
                 @include('Presentacion_Perfume.search')  
            </div>
         </div>
      </div>
        ...
        <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$variable->volumen_ml}}</td>
               
                <td class="d-flex justify-content-between">
                    
                    <a class="btn btn-info btn-sm" href="{{action('PrespController@edit', $variable->id)}}">
              ...
              @include('Presentacion_Perfume.delete')
